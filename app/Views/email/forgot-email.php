...
<body style="background-color: #deedf0; padding: 20px;">
    ...
    <div class="auth-content" style="background-color: white;">
        ...
        <p>
            Anda menerima email ini karena Anda telah meminta link untuk melakukan reset password di <a href="<?= base_url() ?>"><?= APP_NAME ?></a>.
            <br>
            Segera reset password Anda dengan menekan tombol di bawah ini.
        </p>

        <a href="<?= $url ?>" style="color: white;" class="auth-button">Reset Password</a>

        <p>
            Link reset password tersebut akan kedaluwarsa dalam 30 menit.
            <br>
