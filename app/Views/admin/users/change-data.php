...
<div class="card mx-auto" style="max-width: 555px;">
    <div class="card-header">
        <h5 class="my-auto mx-auto text-center">Ubah Data <a href="<?= base_url('account/profile/' . $user['slug']) ?>" class="link"><?= $user['username'] ?></a></h5>
    </div>
    <div class="card-body">
        <form action="<?= base_url('admin/user/change-data/' . $user['id']) ?>" method="post">
            <!-- CSRF -->
            <?= csrf_field(); ?>
            <!-- Method Spoofing -->
